# 🔧 Troubleshooting Guide — LLM Gateway & API Router Studio
...
2. **Check official documentation:**
   - [GitHub Issues for this repo](https://github.com/Pradeeptalari14/tp-llm-gateway/issues)
   - [Studio FAQ](https://pradeeptalari14.github.io/portfolio/tools/llm-gateway/)
