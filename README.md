# 🚦 LLM Gateway & API Router Studio
> Optimize model serving gateways. Scaffold LiteLLM routing configurations, semantic prompt caches, and client API scripts.

[![Studio](https://img.shields.io/badge/Developer_Studio-Live-brightgreen)](https://pradeeptalari14.github.io/portfolio/tools/llm-gateway/)
...
```
1. Open Studio → https://pradeeptalari14.github.io/portfolio/tools/llm-gateway/
...
```bash
git clone https://github.com/Pradeeptalari14/tp-llm-gateway.git
cd tp-llm-gateway
...
| Resource | Link |
|----------|------|
| Interactive Studio | [Open →](https://pradeeptalari14.github.io/portfolio/tools/llm-gateway/) |
